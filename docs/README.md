...
This directory contains documentation for the orders bounded context module.
...
backbone schema generate orders --target docs

# Generate OpenAPI spec only
backbone schema generate orders --target openapi
```
...
**Description:** Order workflow with pickups, deliveries, status timeline (extracted from bersihir)
