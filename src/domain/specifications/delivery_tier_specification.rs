//! Specifications for DeliveryTier aggregate
//!
...
// Each predicate implements `Specification<DeliveryTier>` and can be combined
...
//
// pub struct ActiveDeliveryTierSpec;
// impl Specification<DeliveryTier> for ActiveDeliveryTierSpec {
//     fn is_satisfied_by(&self, e: &DeliveryTier) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
