//! Specifications for OrderPickup aggregate
//!
...
// Each predicate implements `Specification<OrderPickup>` and can be combined
...
//
// pub struct ActiveOrderPickupSpec;
// impl Specification<OrderPickup> for ActiveOrderPickupSpec {
//     fn is_satisfied_by(&self, e: &OrderPickup) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
